...
class FunctionRoomBookingCancellation implements ShouldBroadcast
{
    ...
    public function __construct(FunctionRoomBooking $booking)
    {
        ...
        $this->function_room = $booking->functionRoom->function_room_name ?? 'N/A'; // Assuming relation
    }
    ...
    {
        return 'FunctionRoomBookingCancelled';
    }
}
