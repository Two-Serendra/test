...
class ConciergeAmenityBookingCancellation extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->from('lowriseadmin@twoserendra.com', 'Two Serendra')
            ->subject('Amenity Booking Cancelled')
            ->view('emails.concierge-amenity-booking-cancellation')
            ->with([
                'name' => $name,
