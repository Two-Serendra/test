...
class TestUserPestControlBookingCancellation extends Mailable implements ShouldQueue
{
    use Queueable, SerializesModels;

    public TestPestControlBooking $booking;

    /**
     * Accept main booking + all linked bookings.
     */
    public function __construct(TestPestControlBooking $booking)
    {
    ...
    public function build()
    {
        ...
        return $this->from('lowriseadmin@twoserendra.com', 'Two Serendra')
            ->subject('Pest Control Booking has been Cancelled')
            ->view('emails.user-pest-control-booking-cancellation')
            ->with([
                'name' => $name,
