...
class UserPestControlBookingBellNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        $statusMessage = match ($this->booking->booking_status) {
            1 => "Your pest control booking has been confirmed.",
            2 => "Your pest control booking has been cancelled.",
        };
