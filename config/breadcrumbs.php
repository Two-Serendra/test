...
return [
    ...
    'admin.show.function.rooms' => ['Function Rooms', 'Setup'],
    ...
    'admin.show.events' => ['Manage', 'Events'],
    'admin.search.events' => ['Manage', 'Events'], // search page uses same breadcrumb

    // Pages
    'admin.show.gallery' => ['Pages', 'Gallery'],
    'admin.downloads' => ['Pages', 'Download'],
];
