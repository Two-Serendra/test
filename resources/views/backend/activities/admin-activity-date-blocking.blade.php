...
@section('content')
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <form action="{{ route('admin.search.block.dates') }}" method="GET" id="searchFormActivity"
                    ...
                    <div class="mb-2 mb-md-0">
                        <button type="button" class="btn btn-primary AddDateBlocking badge">
    ...
    @include('backend.modal.activities.dateBlocking-modal')
@endsection