...
@section('content')
    <style>
        * {
        ...
        .filter-btn-ausi:hover,
        .filter-btn-ausi:focus {
            background-color: #28a745 !important;
            color: #fff !important;
            font-weight: bold;
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <div id="calendar-ausi-booking"></div>
            </div>

            <div class="col-md-2">
                <div class="d-flex flex-column gap-2">
                    <button class="btn btn-outline-primary filter-btn-ausi active" data-rise="">
                        All
                    </button>

                    <button class="btn btn-outline-primary filter-btn-ausi filter-btn-rise" data-rise="lowrise">
                        Lowrise
                    </button>

                    <button class="btn btn-outline-primary filter-btn-ausi filter-btn-rise" data-rise="highrise">
                        Highrise
                    </button>
                </div>
            </div>
...
@push('js')
    <script>
        $(document).ready(function () {
            ...
            $('#calendar-ausi-booking').fullCalendar({
                timezone: 'local',
                header: {
                ...
                eventClick: function (event) {
                    ...
                    $.ajax({
                        url: '/admin/fetch/ausi-calendar-details/' + schedule_id,
                        method: 'GET',

                        success: function (data) {
                            $('#calendarModalAusi').modal('show');
            ...
            $('.filter-btn-ausi').on('click', function () {
                ...
                if (selectedRise === "") {
                    $('#calendar-ausi-booking').fullCalendar('removeEvents');
                    $('#calendar-ausi-booking').fullCalendar('addEventSource', schedule);
                    return;
                }
                ...
                $('#calendar-ausi-booking').fullCalendar('removeEvents');
                $('#calendar-ausi-booking').fullCalendar('addEventSource', filteredEvents);
            });
