        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-6  d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <form action="{{ route('admin.search.ausi.report') }}" method="GET" id="searchAusiBookingForm"
                        ...
                        <div class="input-group text-dark w-100">
                            ...
                            <input type="text" name="searchAusiReport" value="{{ $searchAusiReport ?? '' }}"
                                id="searchInputAusiReport" class="form-control" placeholder="Name/Unit" autocomplete="off">
                        </div>
                    </form>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="sticky-col sticky-col-color">
                                        <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <button type="button"
                                                class="btn btn-sm {{ $disableInspect ? 'btn-secondary' : 'btn-success' }} report_inspection_ausi_booking"
                                            ...
                                            <button type="button"
                                                class="btn btn-sm btn-equal {{ $disableActions ? 'btn-secondary cancel-booking' : 'btn-danger report-ausi-booking-cancel' }}"
