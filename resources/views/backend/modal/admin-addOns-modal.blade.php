...
<div class="modal fade" id="adminEditBookingModal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <form id="adminEditBookingForm" 
                  action="{{ route('admin.update.function.room.booking') }}" 
                  method="POST"
                  enctype="multipart/form-data" 
                  class="needs-validation" novalidate>
                @csrf
                <!-- hidden booking_id (like info_id in add-ons modal) -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 border-end pe-4">
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-white text-dark"
                                               id="editFunctionRoomBookingDate" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" 
                                           name="pax" id="editPaxInput" min="1" required>
                                    <small class="text-danger d-none" id="capacityError">
                                        Max capacity is <span id="editRoomCapacity">0</span>
                                    </small>
                                </div>
                            ...
                            <div id="authorizationUploadWrapper" class="col-md-12 d-none mb-4">
                                ...
                                <div id="authorizationPreview" class="mb-2 d-none">
                                    <a href="#" target="_blank" class="btn btn-sm btn-outline-primary"
                                       id="authorizationViewLink">View Current Authorization</a>
                                    <small class="text-muted d-block mt-2">Upload a new file to replace this.</small>
                                </div>

                                <input type="file" name="authorization_file" 
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="hasSuppliers">
                                    I have Catering / Other Supplier
                                </label>
                            </div>
                            <div id="supplierSection" class="col-12 mt-2 d-none">
                                ...
                                <div id="suppliersWrapper">
                                    <div class="row g-2 supplier-item mb-2">
                                        <div class="col-md-4">
                                            <input type="text" name="suppliers[0][name]" 
                                                   class="form-control" placeholder="Name">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="file" name="suppliers[0][attachment]" 
                                                   class="form-control" accept="image/*,.pdf">
                                        </div>
                                    </div>
                                </div>
