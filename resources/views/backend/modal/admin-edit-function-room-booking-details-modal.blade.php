                    ...
                    <div class="row">
                        <div class="col-lg-7 border-end pe-4">
                            <div class="row g-3 mb-4">
                                ...
                                <input type="text" class="form-control" name="discount_remarks" id="editDiscountRemarks">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="pax" id="editPaxInput" min="1" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="contact_number" id="editContactNumber"
                                    required>
                            </div>
                        </div>
