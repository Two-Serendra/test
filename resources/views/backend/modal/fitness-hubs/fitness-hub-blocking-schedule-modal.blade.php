<div class="modal fade" id="addFitnessHubBlockingModal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('admin.new.schedule.blocking.fitness.hub') }}"
            id="FitnessHubScheduleBlocking" method="POST" enctype="multipart/form-data"
            class="FitnessHubScheduleBlocking needs-validation" novalidate>
            @csrf

            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title">Create Fitness Hub Blocking</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Fitness Hub</label>
                                <select name="fitness_hub_id" class="form-select" required>
                                    <option value="">Select Fitness Hub</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="FitnessHubScheduleBlocking" id="saveAFitnessHubScheduleBlockingBtn"
