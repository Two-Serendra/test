            ...
            <div class="modal-body px-4 py-3">
                ...
                <div class="text-center mb-4">
                    <h5 class="fw-bold mb-1">Complete Grease Trap Booking</h5> <small class="">
                        Reference #: <span id="complete_transaction_no"></span>
                    </small>
                </div>

                <form action="{{ route('admin.grease.trap.booking.complete') }}" id="completeGreaseTrapBookingForm"
                    method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="card shadow-sm border-0 rounded-4 h-100 p-4">
                                <input type="hidden" id="complete_info_id" name="id">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="complete_srf_no" name="srf_no" required>
                                </div>
