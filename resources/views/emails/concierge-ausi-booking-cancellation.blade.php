...
<head>
    <meta charset="UTF-8">
    <title>AUSI Booking Cancelled</title>
</head>
...
<body style="font-family: Arial, sans-serif; background:#f4f6f8; padding:20px; color:#333;">
    <div style="max-width:700px; margin:auto; background:#ffffff; border-radius:6px; border:1px solid #e5e5e5;">
        ...
        <div style="padding:25px;">
            <h2 style="color:#dc3545;">AUSI Booking Cancelled</h2>

            <p>A resident AUSI booking has been <strong>cancelled</strong>. Please review the details below:</p>
