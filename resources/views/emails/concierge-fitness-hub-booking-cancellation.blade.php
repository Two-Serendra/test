...
<body style="font-family: Arial, sans-serif; background-color:#f4f6f8; padding:20px; color:#333;">
    <div
        ...
        <div style="padding:30px;">
            <h2 style="color:#dc3545;">Fitness Hub Booking Cancelled</h2>

            <p>A resident fitness hub booking has been <strong>cancelled</strong>. Please review the details below:</p>
            ...
            <table style="width:100%; border-collapse:collapse; margin-top:15px;">
                ...
                <tr>
                    <td style="padding:8px 0;"><strong>Fitness Hub:</strong></td>
                    <td>{{ $fitness_hub_name ?? 'N/A' }}</td>
                </tr>
                <tr>
