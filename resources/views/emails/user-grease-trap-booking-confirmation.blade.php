...
<head>
    <meta charset="UTF-8">
    <title>Grease Trap Booking Confirmed</title>
</head>
...
<body style="font-family: Arial, sans-serif; color: #333;">
    <div style="max-width: 600px; margin: auto; border: 1px solid #eee; padding: 30px; background-color: #f9f9f9;">
        ...
        <p>Good news! Your Grease Trap booking with <strong>Two Serendra</strong> has been <strong>confirmed</strong>.
        </p>
        ...
        @else
            <div style="margin-top:15px; padding:12px; background:#e6fffa; border-left:5px solid #28a745;">
                ...
                You used your complimentary yearly grease trap service.
            </div>
        @endif
