            ...
            @if($bookings->count())
                @foreach ($bookings as $b)
                    <tr>
                        ...
                        <td>{{ $b->fitnessHub->fitness_hub_name ?? 'N/A' }}</td>
                        ...
                        <td>
                            <button class="btn btn-sm btn-info fitness-hub-booking-details badge-forge text-white"
                                data-id="{{ $b->id }}">
                                View
                            </button>
                        </td>
...
@include('frontend.modal.resident-view-fitness-hub-booking-details-modal')