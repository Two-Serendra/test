    ...
    <div class="container my-4">
        <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
            ...
            <div class="card-header bg-primary text-white text-center py-4">
                ...
                <h5 class="mt-3 mb-0 fw-semibold text-white">Fitness Hub Booking Details</h5>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded-4 h-100">
                            ...
                            <div class="mb-3">
                                <div class="text-muted small">Fitness Hub</div>
                                <div class="fw-semibold">
                                    {{ $booking->fitnessHub->fitness_hub_name ?? 'N/A' }}
                                </div>
                            </div>
