...
<head>
    ...
    <link href="{{ asset('assets/mobile-app/ausi-booking-mobile-v2.css') }}" rel="stylesheet">
...
<body x-data>
    ...
    <script src="{{ asset('assets/frontend/js/mobile-app/ausi-booking-mobile-v4.js') }}"></script>
    ...
    <script src="{{ asset('assets/frontend/js/mobile-app/pest-control-booking-mobile-v5.js') }}"></script>
