        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('ausiBookingPage', () => ({
                ...
                init() {
                    ...
                    this.$watch(() => Alpine.store('superapp').selectedUnit, (value) => {
                        logDebug("unit changed (Alpine)", value);
                        updateSlots();
                    });

                    this.$watch(() => $('#AusiBookingDate').val(), (value) => {
                        logDebug("date changed (watch)", value);
                        updateSlots();
                    });
