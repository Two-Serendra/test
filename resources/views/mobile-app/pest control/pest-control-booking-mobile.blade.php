...
@section('content')
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{ route('pest.control.booking.mobile.history') }}" class="history-shortcut">
                        ...
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <dl>
                                <dd>
                                    ...
                                    <select id="resident_id_pc" name="resident_id_pc" class="form-select"
                            ...
                            <div class="row g-3">
                                @foreach ($slots as $slot)
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <input type="radio" class="btn-check pc-booking-slot" name="booking_time_slot"
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('pestControlBookingPage', () => ({
                residences: [],
